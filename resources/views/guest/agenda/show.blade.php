...
@section('title', $post->judul . ' - Agenda SMKN 4 BOGOR')
...
<div class="container mb-5 mt-4">
    <div class="mb-4">
        <a href="{{ route('guest.agenda') }}" class="back-btn-detail">
                ...
                <div class="gallery-section">
                    @foreach($post->galeries as $galeryIndex => $galery)
                        ...
                        <div class="mb-5 {{ $galeryIndex > 0 ? 'mt-5' : '' }}">
                            ...
                            @endif
                            <div id="agendaCarousel{{ $galeryIndex }}" class="carousel slide" data-bs-ride="false">
                                ...
                                <button class="carousel-control-prev" type="button" data-bs-target="#agendaCarousel{{ $galeryIndex }}" data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next" type="button" data-bs-target="#agendaCarousel{{ $galeryIndex }}" data-bs-slide="next">
