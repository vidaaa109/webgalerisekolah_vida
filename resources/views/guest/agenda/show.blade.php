    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb text-white">
                ...
                <li class="breadcrumb-item"><a href="{{ route('guest.agenda') }}" class="text-white">Agenda</a></li>
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('guest.agenda') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    <h5 class="card-title fw-bold mb-3">Agenda Terkait</h5>
                    
                    @forelse($relatedPosts as $related)
                    <div class="mb-3 pb-3 border-bottom">
                        <h6 class="mb-2">
                            <a href="{{ route('guest.agenda.show', $related) }}" class="text-decoration-none text-dark">
                                {{ $related->judul }}
                            </a>
                        </h6>
                    ...
                    @empty
                    <p class="text-muted small mb-0">Tidak ada agenda terkait</p>
                    @endforelse
                </div>
            </div>
        </div>
